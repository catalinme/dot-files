...
Usage:
 ...
 1. Double-click LanguageTool-1.4-dev.oxt. The extension should
...
Using LanguageTool from .NET:
 ...
 mono /path/to/ikvm/bin/ikvmc.exe -target:library -r:/path/to/ikvm/bin/IKVM.OpenJDK.Core.dll libs/morfologik-stemming-nodict-1.4.0.jar
 mono /path/to/ikvm/bin/ikvmc.exe -target:library -r:/path/to/ikvm/bin/IKVM.OpenJDK.Core.dll libs/jWordSplitter.jar
 mono /path/to/ikvm/bin/ikvmc.exe -r:/path/to/ikvm/bin/IKVM.OpenJDK.Core.dll -r:morfologik-stemming-nodict-1.4.0.jar -r:jWordSplitter.dll LanguageTool.jar
